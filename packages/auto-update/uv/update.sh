...
function url_for() {
    echo "https://github.com/astral-sh/uv/releases/download/${version}/uv-${1}.tar.gz"
}

function hash_for() {
    local url="https://github.com/astral-sh/uv/releases/download/${version}/uv-${1}.tar.gz.sha256"
